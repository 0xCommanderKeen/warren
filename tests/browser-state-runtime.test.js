...
const { hydrate } = require("../viewer/browser-runtime.js");

const state = {
  schema_version: 1, generation: 4, cursor: "cursor-4", evaluated_at: "2026-08-26T12:00:00.000Z",
...
assert.equal(view.transport, "live");
