...
class ProtocolContractTest(unittest.TestCase):
    ...
    def test_structured_knock_shape_is_additive_and_source_independent(self):
        event = {
            "v": 0, "ts": "2026-08-25T10:00:00.000Z", "source": "codex",
            "agent_id": "codex:keeper", "project": "life", "type": "needs_human",
            "payload": {"message": "May I?", "request_id": "r1", "action": "send_email",
    ...
    def test_resolution_contract_is_strict_and_steward_authoritative(self):
        event = {
            "v": 0, "ts": "2026-08-25T10:01:00.000Z", "source": "steward",
        ...
        self.assertEqual(validate_event(event),
                         "approval resolutions require source steward")
