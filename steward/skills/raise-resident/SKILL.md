---
name: raise-resident
description: Draft a new resident, declare the skeleton, and hand the provision to
  Miha. Use when a job arrives that no resident covers, or Miha asks for one.
---
