---
name: write-skill
description: Write a skill into steward's library, from the interview to the commit
  hash. Use when someone asks for a new skill, or a skill nobody holds yet needs rewriting.
---
